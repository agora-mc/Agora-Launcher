...
description: 'Architecture overview of the Agora Minecraft mod launcher monorepo. Use when: understanding project layout, data flow, compiler pipeline, Tauri desktop app, Next.js web directory, or security principles before making changes.'
---
# Agora Architecture

---
name: tauri-security
description: 'Security hardening rules for the Tauri desktop application. Use when: modifying desktop/ configuration or code, Tauri capabilities, CSP, shell scopes, SQL, OAuth token storage, or modpack sandboxing.'
---
# Tauri Security
